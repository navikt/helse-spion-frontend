...
class Environment {
    ...
    get loginServiceUrl() {
        switch (this.environmentMode) {
            ...
            case EnvironmentType.PREPROD_DEV : return 'https://loginservice.dev.nav.no/login?redirect=https://arbeidsgiver-min-side-refusjon.dev.nav.no';
            case EnvironmentType.PREPROD_Q : return 'https://loginservice-q.nav.no/login?redirect=https://arbeidsgiver-q.nav.no/min-side-refusjon/';
    ...
    get baseUrl() {
        switch (this.environmentMode) {
            ...
            case EnvironmentType.PREPROD_DEV : return 'https://arbeidsgiver-min-side-refusjon.dev.nav.no/min-side-refusjon';
            case EnvironmentType.PREPROD_Q : return 'https://arbeidsgiver-q.nav.no/min-side-refusjon';
