...
describe('Environment', () => {
  it('should return the loginservice url for localhost', () => {
    expect(env.loginServiceUrl).toBe('http://localhost:8080/local/cookie-please?subject=12321&redirect=http://localhost:3000/min-side-refusjon/');
  });
  ...
  it('should return the loginservice url for preprod dev', () => {
    ...
    expect(env.loginServiceUrl).toBe('https://loginservice.dev.nav.no/login?redirect=https://arbeidsgiver-min-side-refusjon.dev.nav.no');
  });
  ...
  it('should return the loginservice url for preprod q', () => {
    ...
    expect(env.loginServiceUrl).toBe('https://loginservice-q.nav.no/login?redirect=https://arbeidsgiver-q.nav.no/min-side-refusjon/');
  })
  ...
  it('should return the loginservice url for prod', () => {
    ...
    expect(env.loginServiceUrl).toBe('https://loginservice.nav.no/login?redirect=https://arbeidsgiver.nav.no/min-side-refusjon/');
  })
  ...
  it('should return the baseUrl url for preprod dev', () => {
    ...
    expect(env.baseUrl).toBe('https://arbeidsgiver-min-side-refusjon.dev.nav.no/min-side-refusjon');
  });
