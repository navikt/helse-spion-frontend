...
import * as useYtelsesperioder from '../data/useYtelsesperioder';

describe('FnrSokeside', () => {
  it('should render the component and display an info text2', () => {
    const mockHook = jest.fn();
    jest.spyOn(useYtelsesperioder, 'default').mockImplementationOnce(mockHook);
    const rendered = render(
      <StoreProvider>
        <FnrSokeside arbeidsgiverId='123456789' />
      </StoreProvider>
    );
